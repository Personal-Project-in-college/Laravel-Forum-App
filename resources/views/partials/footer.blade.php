<footer class="mt-auto w-full py-10 mx-auto border-gray-200 border-t dark:bg-neutral-800 dark:border-neutral-700">
    ...
    <div class="text-center px-2">
        <!-- = Brand footer = -->
        <div>
            <a class="flex-none text-xl font-semibold text-black dark:text-white" href="#" aria-label="Ngestuck">Ngestuck</a>
        </div>
        <!-- = End Brand footer = -->

        <!-- = Description footer = -->
        <div class="mt-3">
            <p class="text-gray-500 dark:text-white">Kami adalah bagian dari keluarga <a class="text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500" href="#">Pengembang</a> Himatikom.</p>
