...
@section('content')
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="rounded-[20px] relative overflow-hidden z-10">
            <!-- Hero Content Start -->
            <div class="max-w-[880px] mx-auto px-4 sm:px-8 lg:px-0 py-12 sm:py-10 lg:py-15 relative z-1">
                <div class="flex flex-col sm:flex-row items-center gap-16 lg:gap-15">
                    <div
                    ...
                    <div class="max-w-[593px] w-full">
                        <h1
                            class="text-2xl sm:text-4xl lg:text-heading-3 xl:text-heading-2 text-gray-900 dark:text-white mb-3.5">
                            Hey! I’m <span class="font-bold"> Smith</span>
                        </h1>
                        ...
                        <div class="flex items-center gap-5 mt-7">
                            <a href="#"
                                class="flex text-gray-900 hover:text-gray-400 dark:text-neutral-400 dark:hover:text-white">
        ...
        <div>
            <div class="mx-auto max-w-screen-sm text-center lg:mb-16 sm:mb-8">
                ...
                <p class="hidden sm:block text-center font-light text-gray-500 sm:text-xl dark:text-gray-400">
                    Kumpulan post pribadi yang dibagikan pengguna ini.</p>
            </div>
        </div>
